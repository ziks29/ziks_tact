...
export function loadChangeExampleOwner(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 3797952890) { throw Error('Invalid prefix'); }
    let _newOwner = sc_0.loadAddress();
    return { $$type: 'ChangeExampleOwner' as const, newOwner: _newOwner };
}
...
export function storeLastMessage(src: LastMessage) {
    return (builder: Builder) => {
        let b_0 = builder;
        if (src.lastMessage !== null && src.lastMessage !== undefined) { b_0.storeBit(true).storeStringRefTail(src.lastMessage); } else { b_0.storeBit(false); }
        b_0.storeAddress(src.lastSender);
        b_0.storeAddress(src.lastReciver);
    };
}

export function loadLastMessage(slice: Slice) {
    let sc_0 = slice;
    let _lastMessage = sc_0.loadBit() ? sc_0.loadStringRefTail() : null;
    let _lastSender = sc_0.loadMaybeAddress();
    let _lastReciver = sc_0.loadMaybeAddress();
    return { $$type: 'LastMessage' as const, lastMessage: _lastMessage, lastSender: _lastSender, lastReciver: _lastReciver };
}

function loadTupleLastMessage(source: TupleReader) {
    let _lastMessage = source.readStringOpt();
    let _lastSender = source.readAddressOpt();
    let _lastReciver = source.readAddressOpt();
    return { $$type: 'LastMessage' as const, lastMessage: _lastMessage, lastSender: _lastSender, lastReciver: _lastReciver };
}

function storeTupleLastMessage(source: LastMessage) {
    let builder = new TupleBuilder();
    builder.writeString(source.lastMessage);
    builder.writeAddress(source.lastSender);
    builder.writeAddress(source.lastReciver);
    return builder.build();
}
...
async function Proxy_init(owner: Address) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
...
const Proxy_types: ABIType[] = [
    ...
    {"name":"ChangeExampleOwner","header":3797952890,"fields":[{"name":"newOwner","type":{"kind":"simple","type":"address","optional":false}}]},
    {"name":"LastMessage","header":null,"fields":[{"name":"lastMessage","type":{"kind":"simple","type":"string","optional":true}},{"name":"lastSender","type":{"kind":"simple","type":"address","optional":true}},{"name":"lastReciver","type":{"kind":"simple","type":"address","optional":true}}]},
]
